...
log4j = {
	...
	warn 'warn': [
		'grails.app.controllers.com.csra',
		'grails.app.services.com.csra',
		'grails.app.conf.com.csra',
		'grails.app.domain.com.csra'
	]
	...
	info	activity: ['grails.app.filters.com.csra.epa.filters.LoggingFilters']
...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.csra.epa.domains.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.csra.epa.domains.UserRole'
grails.plugin.springsecurity.authority.className = 'com.csra.epa.domains.Role'
